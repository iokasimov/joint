...
instance (Functor (Schema u v), Applicative v, Transformer u, Transformer t) => Liftable u (t :> u :> v) where
	lift = T . embed . T . build

instance (Functor (Schema u v), Functor v, Transformer u, Transformer t) => Liftable v (t :> u :> v) where
